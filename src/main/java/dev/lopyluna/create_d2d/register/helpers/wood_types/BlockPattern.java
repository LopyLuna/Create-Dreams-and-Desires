...
import static dev.lopyluna.create_d2d.register.helpers.wood_types.BlockPartial.ALL_PARTIALS;
import static dev.lopyluna.create_d2d.register.helpers.wood_types.BlockPartial.FOR_POLISHED;
...
public class BlockPattern {
    ...
    protected static ResourceLocation toLocation(String variant, String texture) {
        return DesiresCreate.loc(String.format(TEXTURE_LOCATION, texture, variant + (texture.equals("cut") ? "_" : "_cut_") + texture));
    }
