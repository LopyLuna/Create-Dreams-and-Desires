package dev.lopyluna.create_d2d.content.configs.server.kinetics;
...
public class DStress extends ConfigBase {
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            DEFAULT_IMPACTS.put(DesiresCreate.loc(builder.getName()), value);
            return builder;
        };
    }
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setCapacity(double value) {
        return builder -> {
            assertFromCreateD2D(builder);
            DEFAULT_CAPACITIES.put(DesiresCreate.loc(builder.getName()), value);
            return builder;
        };
    }
