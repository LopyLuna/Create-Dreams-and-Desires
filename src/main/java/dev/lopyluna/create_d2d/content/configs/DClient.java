...
public class DClient extends ConfigBase {
    ...
    public final ConfigFloat sapTransparencyMultiplier = f(.125f, .125f, 128, "sap", Comments.sapTransparencyMultiplier);
    public final ConfigFloat chocolateTransparencyMultiplier = f(.125f, .125f, 128, "chocolateTransparencyMultiplier", Comments.chocolateTransparencyMultiplier);
    public final ConfigFloat vanillaTransparencyMultiplier = f(.125f, .125f, 128, "vanillaTransparencyMultiplier", Comments.vanillaTransparencyMultiplier);
    public final ConfigFloat glowberryTransparencyMultiplier = f(.125f, .125f, 128, "glowberryTransparencyMultiplier", Comments.glowberryTransparencyMultiplier);
    public final ConfigFloat strawberryTransparencyMultiplier = f(.125f, .125f, 128, "strawberryTransparencyMultiplier", Comments.strawberryTransparencyMultiplier);
    public final ConfigFloat pumpkinTransparencyMultiplier = f(.125f, .125f, 128, "pumpkinTransparencyMultiplier", Comments.pumpkinTransparencyMultiplier);
