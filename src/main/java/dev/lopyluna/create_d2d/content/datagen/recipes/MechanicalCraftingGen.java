package dev.lopyluna.create_d2d.content.datagen.recipes;

import com.google.common.base.Supplier;
import com.simibubi.create.AllItems;
import com.simibubi.create.foundation.data.recipe.MechanicalCraftingRecipeBuilder;
import dev.lopyluna.create_d2d.DesiresCreate;
import dev.lopyluna.create_d2d.content.datagen.DesiresRecipeProvider;
    ...
    class GeneratedRecipeBuilder {
        ...
        GeneratedRecipe recipe(UnaryOperator<MechanicalCraftingRecipeBuilder> builder) {
            return register(output -> {
                ...
                ResourceLocation location = DesiresCreate.loc("mechanical_crafting/" + RegisteredObjectsHelper.getKeyOrThrow(result.get().asItem()).getPath() + suffix);
