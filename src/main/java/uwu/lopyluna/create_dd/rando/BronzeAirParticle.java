...
public class BronzeAirParticle extends SimpleAnimatedParticle {
    ...
    protected BronzeAirParticle(ClientLevel world, DDAirParticleData data, double x, double y, double z, double dx, double dy,
    ...
    public static class Factory implements ParticleProvider<DDAirParticleData> {
        ...
        public Particle createParticle(DDAirParticleData data, ClientLevel worldIn, double x, double y, double z, double xSpeed,
            ...
            return new BronzeAirParticle(worldIn, data, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
        }
    }
