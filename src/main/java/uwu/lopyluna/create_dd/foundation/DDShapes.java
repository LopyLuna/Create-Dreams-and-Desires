...
public class DDShapes {
	...
	private static DDShapes.Builder shape(VoxelShape shape) {
		return new DDShapes.Builder(shape);
	}

	private static DDShapes.Builder shape(double x1, double y1, double z1, double x2, double y2, double z2) {
	...
	public static class Builder {
		...
		public DDShapes.Builder add(VoxelShape shape) {
			this.shape = Shapes.or(this.shape, shape);
			return this;
		}

		public DDShapes.Builder add(double x1, double y1, double z1, double x2, double y2, double z2) {
			return add(cuboid(x1, y1, z1, x2, y2, z2));
		}

		public DDShapes.Builder erase(double x1, double y1, double z1, double x2, double y2, double z2) {
