...
@JeiPlugin
@SuppressWarnings({"unused", "inline", "all", "removal"})
...
public class DDcreateJEI implements IModPlugin {
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(DDBlocks.hydraulic_press.asStack(), new ResourceLocation(Create.ID, "pressing"));
        registration.addRecipeCatalyst(DDBlocks.hydraulic_press.asStack(), new ResourceLocation(Create.ID, "automatic_packing"));
        registration.addRecipeCatalyst(DDBlocks.hydraulic_press.asStack(), new ResourceLocation(Create.ID, "packing"));
        registration.addRecipeCatalyst(DDBlocks.BRONZE_SAW.asStack(), new ResourceLocation(Create.ID, "sawing"));
        registration.addRecipeCatalyst(DDBlocks.BRONZE_SAW.asStack(), new ResourceLocation(Create.ID, "block_cutting"));
        registration.addRecipeCatalyst(DDBlocks.BRONZE_SAW.asStack(), new ResourceLocation(Create.ID, "wood_cutting"));
        registration.addRecipeCatalyst(DDBlocks.industrial_fan.asStack(), new ResourceLocation(Create.ID, "fan_washing"));
        registration.addRecipeCatalyst(DDBlocks.industrial_fan.asStack(), new ResourceLocation(Create.ID, "fan_smoking"));
        registration.addRecipeCatalyst(DDBlocks.industrial_fan.asStack(), new ResourceLocation(Create.ID, "fan_blasting"));
        registration.addRecipeCatalyst(DDBlocks.industrial_fan.asStack(), new ResourceLocation(Create.ID, "fan_haunting"));
    }
