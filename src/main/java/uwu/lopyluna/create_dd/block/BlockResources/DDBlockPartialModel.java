...
public class DDBlockPartialModel {
    ...
    public static final PartialModel
            ...
            RADIANT_PANEL = block("radiant_panel/panel"),
            RADIANT_PANEL_GLOW = block("radiant_panel/panel_glow"),
            RADIANT_COG = block("radiant_panel/cog"),
            SHADOW_PANEL = block("shadow_panel/panel"),
            SHADOW_COG = block("shadow_panel/cog"),
