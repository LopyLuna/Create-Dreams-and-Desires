...
import uwu.lopyluna.create_dd.block.BlockProperties.industrial_fan.fan_type.FreezingType;
import uwu.lopyluna.create_dd.block.BlockProperties.industrial_fan.fan_type.SuperheatingType;
...
public class IndustrialTypeFanProcessing {
    public static final IndustrialTypeFanProcessing.NoneType NONE = register("none", new IndustrialTypeFanProcessing.NoneType());
    public static final IndustrialTypeFanProcessing.BlastingType BLASTING = register("blasting", new IndustrialTypeFanProcessing.BlastingType());
    public static final IndustrialTypeFanProcessing.HauntingType HAUNTING = register("haunting", new IndustrialTypeFanProcessing.HauntingType());
    public static final IndustrialTypeFanProcessing.SmokingType SMOKING = register("smoking", new IndustrialTypeFanProcessing.SmokingType());
    public static final IndustrialTypeFanProcessing.SplashingType SPLASHING = register("splashing", new IndustrialTypeFanProcessing.SplashingType());
