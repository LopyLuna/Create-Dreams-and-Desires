...
public class FurnaceFlywheelInstance extends KineticBlockEntityInstance<FurnaceFlywheelBlockEntity> implements DynamicInstance {

	protected final RotatingData shaft;
	protected final ModelData wheel;
	protected float lastAngle = Float.NaN;

	public FurnaceFlywheelInstance(MaterialManager materialManager, FurnaceFlywheelBlockEntity blockEntity) {
