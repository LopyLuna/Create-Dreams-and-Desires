...
import static uwu.lopyluna.create_dd.block.BlockProperties.drill.radiant.RadiantDrillBlockBreakingKineticBlockEntity.fortunedestroyBlock;
...
public class RadiantDrillMovementBehaviour extends BlockBreakingMovementBehaviour {
    ...
    protected DamageSource getDamageSource() {
        return RadiantDrillBlock.damageSourceDrill;
    }
    ...
    public boolean canBreak(Level world, BlockPos breakingPos, BlockState state) {
        return super.canBreak(world, breakingPos, state) && !state.getCollisionShape(world, breakingPos)
                .isEmpty() && !AllTags.AllBlockTags.TRACKS.matches(state) && !DDTags.AllBlockTags.radiant_drill_immune.matches(state);
    }
