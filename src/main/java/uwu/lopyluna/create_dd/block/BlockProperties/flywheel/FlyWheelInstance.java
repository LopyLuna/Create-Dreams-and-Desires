...
public class FlyWheelInstance extends KineticBlockEntityInstance<FlywheelBlockEntity> implements DynamicInstance {
    ...
    public FlyWheelInstance(MaterialManager modelManager, FlywheelBlockEntity tile) {
        ...
        wheel = getTransformMaterial()
                .getModel(DDBlockPartialModel.FLYWHEEL, referenceState, referenceState.getValue(HORIZONTAL_FACING))
                .createInstance();
        ...
        if (connection != null) {
            ...
            upperRotating = mat.getModel(DDBlockPartialModel.FLYWHEEL_UPPER_ROTATING, blockState)
                    .createInstance();
            lowerRotating = mat.getModel(DDBlockPartialModel.FLYWHEEL_LOWER_ROTATING, blockState)
                    .createInstance();
            upperSliding = mat.getModel(DDBlockPartialModel.FLYWHEEL_UPPER_SLIDING, blockState)
                    .createInstance();
            lowerSliding = mat.getModel(DDBlockPartialModel.FLYWHEEL_LOWER_SLIDING, blockState)
                    .createInstance();
