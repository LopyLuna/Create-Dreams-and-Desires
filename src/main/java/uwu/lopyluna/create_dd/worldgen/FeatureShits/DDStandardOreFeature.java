...
public class DDStandardOreFeature extends DDBaseConfigDrivenOreFeature<DDConfigDrivenOreFeatureConfiguration> {

    public DDStandardOreFeature() {
        super(DDConfigDrivenOreFeatureConfiguration.CODEC);
    }
