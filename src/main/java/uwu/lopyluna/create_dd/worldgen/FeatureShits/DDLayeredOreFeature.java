...
public class DDLayeredOreFeature extends DDBaseConfigDrivenOreFeature<DDConfigDrivenLayeredOreFeatureConfiguration> {
    public DDLayeredOreFeature() {
        super(DDConfigDrivenLayeredOreFeatureConfiguration.CODEC);
    }
