...
import uwu.lopyluna.create_dd.content.items.ItemDisabled;
import uwu.lopyluna.create_dd.content.items.compound.ChromaticCompound;
import uwu.lopyluna.create_dd.content.items.compound.RefinedRadiance;
import uwu.lopyluna.create_dd.content.items.compound.ShadowSteel;
...
import uwu.lopyluna.create_dd.content.items.sawtool.DeforesterRender;
import uwu.lopyluna.create_dd.content.items.sawtool.ForestRavagerItem;
import uwu.lopyluna.create_dd.content.items.sawtool.ForestRavagerRender;
import uwu.lopyluna.create_dd.content.items.sequenced.SequencedCraftingItem1;
import uwu.lopyluna.create_dd.content.items.sequenced.SequencedCraftingItem2;
