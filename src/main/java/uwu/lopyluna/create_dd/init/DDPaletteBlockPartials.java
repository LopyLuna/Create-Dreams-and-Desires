...
import uwu.lopyluna.create_dd.content.decoration.DDPaletteBlockPattern;
...
public abstract class DDPaletteBlockPartials<B extends Block> {


	public static final DDPaletteBlockPartials<StairBlock> STAIR = new Stairs();
	public static final DDPaletteBlockPartials<SlabBlock> SLAB = new Slab(false);
	public static final DDPaletteBlockPartials<SlabBlock> UNIQUE_SLAB = new Slab(true);
	public static final DDPaletteBlockPartials<WallBlock> WALL = new Wall();

	public static final DDPaletteBlockPartials<?>[] ALL_PARTIALS = { STAIR, SLAB, WALL };
	public static final DDPaletteBlockPartials<?>[] FOR_POLISHED = { STAIR, UNIQUE_SLAB, WALL };

	private String name;

	private DDPaletteBlockPartials(String name) {
		this.name = name;
	}
	...
	private static class Stairs extends DDPaletteBlockPartials<StairBlock> {
		...
		protected StairBlock createBlock(Supplier<? extends Block> block) {
			return StairsBlockHelper.init(block.get().defaultBlockState(), BlockBehaviour.Properties.copy(block.get()));
		}
	...
	private static class Slab extends DDPaletteBlockPartials<SlabBlock> {
		...
		protected void createRecipes(DDPaletteStoneTypes type, BlockEntry<? extends Block> patternBlock,
			...
			ShapelessRecipeBuilder.shapeless(patternBlock.get())
					...
					.save(p, DDcreate.ID + ":" + c.getName() + "_recycling");
		}
	...
	private static class Wall extends DDPaletteBlockPartials<WallBlock> {
