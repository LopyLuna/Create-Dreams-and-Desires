...
public class DDPaletteVariant {
	...
	public DDPaletteVariant(String name, DDPaletteStoneTypes paletteStoneVariants) {
		...
		for (DDPaletteBlockPattern pattern : paletteStoneVariants.variantTypes) {
			...
			for (DDPaletteBlockPartials<? extends Block> partialBlock : pattern.getPartials())
