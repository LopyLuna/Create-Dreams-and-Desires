...
import uwu.lopyluna.create_dd.foundation.access.DDServerPlayer;
...
public class BronzeAirCurrent {
	...
	public void tickAffectedHandlers() {
		for (Pair<TransportedItemStackHandlerBehaviour, BakingFanProcessing.Type> pair : affectedItemHandlers) {
			TransportedItemStackHandlerBehaviour handler = pair.getFirst();
			Level world = handler.getWorld();
			BakingFanProcessing.Type processingType = pair.getSecond();
