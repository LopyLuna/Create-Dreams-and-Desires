package uwu.lopyluna.create_dd.content.block.fan;
...
public class EightBladeFanBlockInstance extends KineticBlockEntityInstance<EightBladeFanBlockEntity> implements DynamicInstance {

	protected final RotatingData shaft;
	protected final ModelData wheel;
	protected float lastAngle = Float.NaN;

	public EightBladeFanBlockInstance(MaterialManager materialManager, EightBladeFanBlockEntity blockEntity) {
