...
public class TwoBladeFanBlockInstance extends KineticBlockEntityInstance<TwoBladeFanBlockEntity> implements DynamicInstance {

	protected final RotatingData shaft;
	protected final ModelData wheel;
	protected float lastAngle = Float.NaN;

	public TwoBladeFanBlockInstance(MaterialManager materialManager, TwoBladeFanBlockEntity blockEntity) {
