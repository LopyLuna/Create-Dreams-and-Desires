...
public class ForestRavagerRender extends CustomRenderedItemModelRenderer {
    protected static final PartialModel ITEM = new PartialModel(Flavoredcreate.asResource("item/forest_ravager/item"));
    protected static final PartialModel GEAR = new PartialModel(Flavoredcreate.asResource("item/forest_ravager/gear"));
    protected static final PartialModel CORE = new PartialModel(Flavoredcreate.asResource("item/forest_ravager/core"));
    protected static final PartialModel CORE_GLOW = new PartialModel(Flavoredcreate.asResource("item/forest_ravager/core_glow/item"));
    @Override
