...
import static uwu.lopyluna.create_flavored.block.YIPPEEBlockPartial.ALL_PARTIALS;
import static uwu.lopyluna.create_flavored.block.YIPPEEBlockPartial.FOR_POLISHED;
...
public class YIPPEEPaletteBlockPattern {
    ...
    protected static ResourceLocation toLocation(String variant, String texture) {
        return Flavoredcreate.asResource(
