...
public class LargeDrillRenderer extends KineticBlockEntityRenderer<LargeDrillBlockEntity> {

    public LargeDrillRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public static void renderInContraption(MovementContext context, VirtualRenderWorld renderWorld,
        ...
        Direction facing = state.getValue(LargeDrillBlock.FACING);
