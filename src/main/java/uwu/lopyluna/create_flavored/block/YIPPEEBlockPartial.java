...
public abstract class YIPPEEBlockPartial<B extends Block> {


    public static final YIPPEEBlockPartial<StairBlock> STAIR = new YIPPEEBlockPartial.Stairs();
    public static final YIPPEEBlockPartial<SlabBlock> SLAB = new YIPPEEBlockPartial.Slab(false);
    public static final YIPPEEBlockPartial<SlabBlock> UNIQUE_SLAB = new YIPPEEBlockPartial.Slab(true);
    public static final YIPPEEBlockPartial<WallBlock> WALL = new YIPPEEBlockPartial.Wall();

    public static final YIPPEEBlockPartial<?>[] ALL_PARTIALS = { STAIR, SLAB, WALL };
    public static final YIPPEEBlockPartial<?>[] FOR_POLISHED = { STAIR, UNIQUE_SLAB, WALL };

    private String name;

    private YIPPEEBlockPartial(String name) {
        this.name = name;
    }

    public @NonnullType BlockBuilder<B, CreateRegistrate> create(String variantName, YIPPEEPaletteBlockPattern pattern,
                                                                 BlockEntry<? extends Block> block, YIPPEEPaletteStoneTypes variant) {
        String patternName = Lang.nonPluralId(pattern.createName(variantName));
        String blockName = patternName + "_" + this.name;

        BlockBuilder<B, CreateRegistrate> blockBuilder = Flavoredcreate.REGISTRATE
    ...
    protected ResourceLocation getTexture(String variantName, YIPPEEPaletteBlockPattern pattern, int index) {
        return YIPPEEPaletteBlockPattern.toLocation(variantName, pattern.getTexture(index));
    }

    protected BlockBuilder<B, CreateRegistrate> transformBlock(BlockBuilder<B, CreateRegistrate> builder,
                                                               String variantName, YIPPEEPaletteBlockPattern pattern) {
    ...
    protected ItemBuilder<BlockItem, BlockBuilder<B, CreateRegistrate>> transformItem(
            ...
            YIPPEEPaletteBlockPattern pattern) {
    ...
    protected abstract void createRecipes(YIPPEEPaletteStoneTypes type, BlockEntry<? extends Block> patternBlock,
    ...
    protected abstract void generateBlockState(DataGenContext<Block, B> ctx, RegistrateBlockstateProvider prov,
                                               String variantName, YIPPEEPaletteBlockPattern pattern, Supplier<? extends Block> block);

    private static class Stairs extends YIPPEEBlockPartial<StairBlock> {
        ...
        @Override
        protected void createRecipes(YIPPEEPaletteStoneTypes type, BlockEntry<? extends Block> patternBlock,
                                     DataGenContext<Block, ? extends Block> c, RegistrateRecipeProvider p) {
    ...
    private static class Slab extends YIPPEEBlockPartial<SlabBlock> {
        ...
        protected void createRecipes(YIPPEEPaletteStoneTypes type, BlockEntry<? extends Block> patternBlock,
            ...
            ShapelessRecipeBuilder.shapeless(patternBlock.get())
                    ...
                    .save(p, Flavoredcreate.MOD_ID + ":" + c.getName() + "_recycling");
        }

        @Override
        protected BlockBuilder<SlabBlock, CreateRegistrate> transformBlock(
                BlockBuilder<SlabBlock, CreateRegistrate> builder, String variantName, YIPPEEPaletteBlockPattern pattern) {
    ...
    private static class Wall extends YIPPEEBlockPartial<WallBlock> {
